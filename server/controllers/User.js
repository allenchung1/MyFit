        ...
        await eachworkout.forEach((line) => {
            ...
            if (line.startsWith("#")) {
                ...
                if (parts.length < 6) {
                    ...
                    console.log("ERROR");
                    return next(createError(400, "Workout string contains an extra line"));
                }
...
const calculateCaloriesBurnt = (workoutDetails) => {
    ...
    const weight = parseInt(workoutDetails.weight)/10;
    const caloriesBurntPerMinute = 5;
    return durationInMinutes * caloriesBurntPerMinute * weight;
}